...
function Banner() {
  return (
    <section className='py-5 lg:py-18 xl:py-16'>
    <div className='container mx-auto gap-8 px-4 flex flex-col md:flex-row'>
      <div className='md:flex-1 md:order-2'>
        <picture className='flex drop-shadow-[10px_-10px_0_hsla(217,33%,17%,0.79)] border-black rounded-xl overflow-hidden'>
          ...
          <source srcSet={BannerImg} width={608} height={372} media='(max-width: 680px)' type='image/jpg'/>
          <img src={BannerImg} alt="Banner with a globe showing Venezuela" width={870} height={532} media='(max-width: 400px)' type='image/jpg' />
        </picture>
      </div>

      <div className='md:flex-1'>
        <h2 className='text-slate-700 text-xl md:text-2xl font-bold'>Hello there! 👋<br /> <span className='text-3xl md:text-4xl font-bold'>I'm Alejandro Rodríguez Hernández</span></h2>
        <br />
