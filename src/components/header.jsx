...
function Header() {
  return (
    <header className='grid grid-cols-2 md:grid-cols-[220px_1fr_220px] border-slate-100 shadow-lg'>
        ...
        <Link to='/contact' className='md:col-start-3 flex gap-2 items-center justify-center text-lg text-slate-200 bg-slate-800  hover:bg-slate-200 hover:text-xl hover:text-slate-900 ease-in-out duration-200'>
            <h2>Let's talk!</h2>
