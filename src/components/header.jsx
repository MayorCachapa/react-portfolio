...
function Header() {
  return (
    <header className='grid grid-cols-2 md:grid-cols-[220px_1fr_220px] border-slate-100 shadow-lg sticky top-0 z-40'>
        ...
        <Link to='/contact' className='md:col-start-3 flex gap-2 items-center justify-center text-lg text-slate-200 bg-slate-700  hover:bg-slate-200 hover:text-xl hover:text-slate-900 ease-in-out duration-200'>
            <h2>Let's talk!</h2>
